...
|*code_sets*: `link:/classes/List[List] <xref:{class_code_set}[CODE_SET]>` [0..1]
a|Code sets in this Terminology.

|*vocabularies*: `link:/classes/List[List] <xref:{class_terminology_group}[TERMINOLOGY_GROUP]>` [0..1]
